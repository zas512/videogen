...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col items-center justify-center gap-6 px-4 py-10 text-center sm:gap-10">
      ...
      <button className="flex items-center rounded-xl bg-gradient-to-r from-[#9d00ff] to-[#ff00ff] px-3 py-2 text-base text-white sm:px-4 sm:py-3 sm:text-xl">
        <BsStars className="mr-2 size-4 sm:size-6" /> <Link href="/dashboard">Try SlickMagic</Link>
      </button>
      <div className="rounded-4xl relative w-[90%] border border-[#ff00ff]/30 p-2 shadow-[0_0_15px_rgba(0,0,0,0.2)] md:p-4 lg:w-[70%] lg:p-6">
        <Image
          src={img2}
          alt="Hero"
          layout="responsive"
